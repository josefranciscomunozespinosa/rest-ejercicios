## Complete Code Example using lombok library

- What's new in the code?
- What happens with the getter, setter, ect?
- And all constructors?
- What does @Slf4j annotation do?

Well! Now we can develop faster!

Check it in your laptop!
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <artifactId>spring-boot-rest-service-basic-lombook</artifactId>
    <version>0.0.1-SNAPSHOT</version>
    <packaging>jar</packaging>

    <name>spring-boot-rest-service-lombook</name>
    <description>Spring Boot and REST + Lombook - Example Project</description>
...
public class StudentController {
    ...
    public Student retrieveStudent(@PathVariable long id) {
        log.info("Vamos a obtener el Student {}", id);
